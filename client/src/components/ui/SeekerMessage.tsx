...
const seekerConversations: Conversation[] = [
  {
    id: 1,
    userId: 201,
    userName: "John's Web Services",
    userType: "provider",
    lastMessage: "I'd be happy to help with your project!",
    timestamp: "5 min ago",
    unreadCount: 2,
    messages: [
      { id: 1, senderId: 0, senderName: "You", message: "Hi! I'm looking for a web developer for my project.", timestamp: "11:00 AM", isSent: true },
      { id: 2, senderId: 201, senderName: "John's Web Services", message: "Hello! I'd love to hear more about your project.", timestamp: "11:05 AM", isSent: false },
      { id: 3, senderId: 0, senderName: "You", message: "I need an e-commerce website. What's your rate?", timestamp: "11:10 AM", isSent: true },
      { id: 4, senderId: 201, senderName: "John's Web Services", message: "I'd be happy to help with your project!", timestamp: "11:15 AM", isSent: false },
    ],
  },
  {
    id: 2,
    userId: 202,
    userName: "Creative Design Studio",
    userType: "provider",
    lastMessage: "Here's a quote for your design needs.",
    timestamp: "30 min ago",
    unreadCount: 1,
    messages: [
      { id: 1, senderId: 0, senderName: "You", message: "I need a logo and branding for my business.", timestamp: "10:00 AM", isSent: true },
      { id: 2, senderId: 202, senderName: "Creative Design Studio", message: "Here's a quote for your design needs.", timestamp: "10:30 AM", isSent: false },
    ],
  },
];
...
export const Message: React.FC<MessagingSystemProps> = ({ userType }) => {
  ...
  const conversations = userType === "provider" ? [] : seekerConversations;
